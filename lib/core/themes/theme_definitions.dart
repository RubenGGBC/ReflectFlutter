...
class ThemeDefinitions {
  ...
  // 🌸 Spring Light Theme (BLANCO PURO)
  static const AppColors springLight = AppColors(
    ...
    accentSecondary: Color(0xFF1E40AF),
    ...
    glassBg: Color(0x1A3B82F6),
    gradientHeader: [Color(0xFF3B82F6), Color(0xFF1E40AF)],
    gradientButton: [Color(0xFF3B82F6), Color(0xFF1E40AF)],
  );

  // 🌅 Sunset Warm Theme (BLANCO PURO)
  static const AppColors sunsetWarm = AppColors(
    name: "sunset_warm",
    displayName: "🌅 Sunset Warm",
    icon: "🌅",
    description: "Claro y cálido",
    isDark: false,
    primaryBg: Color(0xFFFFFFFF),
    secondaryBg: Color(0xFFFFFFFF),
    surface: Color(0xFFFFFFFF),
